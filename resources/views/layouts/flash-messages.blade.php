...
@if(session()->has('success') || session()->has('error') || session()->has('warning') || session()->has('info') || $errors->any())
    <div class="space-y-3 mb-6">
        ...
        @if(session()->has('success'))
            <div class="alert bg-green-50 border-l-4 border-green-400 p-4 rounded-md">
        ...
        @if(session()->has('error'))
            <div class="alert bg-red-50 border-l-4 border-red-400 p-4 rounded-md">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
        ...
        @if(session()->has('warning'))
            <div class="alert bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
        ...
        {{-- Info Messages --}}
        @if(session()->has('info'))
            <div class="alert bg-blue-50 border-l-4 border-blue-400 p-4 rounded-md">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
